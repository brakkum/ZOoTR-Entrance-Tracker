// import RoutingLocationsToSkip from "./Data/RoutingLocationsToSkip";
// import InteriorConnection from "./Data/InteriorConnection";
// import ValidStartPoints from "./Data/ValidStartPoints";
// import DivingEntrances from "./Data/DivingEntrances";
// import OverworldNames from "../Data/Names/OverworldNames";
// import EntranceTypes from "../Data/Types/AreaTypes";
// import { useLocalStorage } from "../Hooks/useLocalStorage";
// import DungeonNames from "../Data/Names/DungeonNames";
// import GrottoNames from "../Data/Names/GrottoEntranceLabels";
...
//         let startIsHouse = HouseEntranceLabels[start] !== undefined;
//         let startIsGrotto = GrottoNames[start] !== undefined;
//         let startIsDungeon = DungeonNames[start] !== undefined;
//         let startIsOverworld = OverworldNames[start] !== undefined;
//
//         let locationIsSong = currentCheck.song !== undefined && WarpSongs[currentCheck.song] !== undefined;
//         let locationIsGrotto = currentCheck.entrance !== undefined && currentCheck.interior !== undefined && GrottoNames[currentCheck.interior] !== undefined;
//         let locationIsHouse = currentCheck.entrance !== undefined && currentCheck.interior !== undefined && HouseEntranceLabels[currentCheck.interior] !== undefined;
//         let locationIsDungeon = currentCheck.entrance !== undefined && currentCheck.interior !== undefined && DungeonNames[currentCheck.interior] !== undefined;
//         let locationIsOverworld = currentCheck.area !== undefined && currentCheck.entrance !== undefined && OverworldNames[currentCheck.area] !== undefined;
...
//             }
//
//             if (currentCheck.interior === HouseEntranceLabels["Link's House"] && config.considerChildSaveWarp) {
//                 return [{ start: start }, { entrance: "Child Save Warp" }, { entrance: HouseEntranceLabels["Link's House"]}];
//             } else if (currentCheck.interior === HouseEntranceLabels["Temple of Time"] && config.considerAdultSaveWarp) {
//                 return [{ start: start }, { entrance: "Adult Save Warp" }, { entrance: HouseEntranceLabels["Temple of Time"]}];
//             }
//
//             if (currentCheck.interior === HouseEntranceLabels["Temple of Time"] ||
//                 currentCheck.interior === HouseEntranceLabels["Windmill"]) {
//                 nextLocationToSearch = currentCheck.interior;
//             }
//
//             let isPotionShop = currentCheck.interior === HouseEntranceLabels["Potion Shop Front"] || currentCheck.interior === HouseEntranceLabels["Potion Shop Back"];
//
//             if (isPotionShop && !(config.ignorePotionShopFromFront && currentCheck.interior === HouseEntranceLabels["Potion Shop Back"])) {
//                 let currentPotionShopEntrance = currentCheck.interior;
//                 let otherPotionShopEntrance = currentPotionShopEntrance === HouseEntranceLabels["Potion Shop Front"] ? HouseEntranceLabels["Potion Shop Back"] : HouseEntranceLabels["Potion Shop Front"];
...
//
//         if (locationIsGrotto) {
//             let isDampesGraveFromWindmill = currentCheck.interior === GrottoNames["Dampe's Grave"] &&
//                 currentCheck.entrance === GrottoNames["Dampe's Grave"] &&
//                 currentCheckLocation === HouseEntranceLabels.Windmill;
//
//             if (startIsGrotto) {
//                 if (currentCheck.interior === start) {
...
//             }
//
//             if (currentCheck.interior === GrottoNames["Dampe's Grave"] && !(isDampesGraveFromWindmill && config.ignoreWindmillFromDampesGrave)) {
//                 nextLocationToSearch = GrottoNames["Dampe's Grave"];
//             }
//         }
//
...
//
//             let isLostWoodsToBridgeEntrance = currentCheck.area === OverworldNames["Lost Woods"] &&
//                 currentCheck.entrance === OverworldNames["Lost Woods Bridge"];
//
//             let isGoronCityToDeathMountainCraterEntrance = currentCheck.area === OverworldNames["Goron City"] &&
//                 currentCheck.entrance === OverworldNames["Death Mountain Crater"];
//
...
//                 (currentCheck.area === OverworldNames["Lost Woods"] || currentCheck.area === OverworldNames["Zora's River"]);
//
//             let isLakeHyliaZorasDomainEntrance = DivingEntrances[currentCheck.area] !== undefined &&
//                 DivingEntrances[currentCheck.area][currentCheck.entrance] !== undefined &&
//                 (currentCheck.area === OverworldNames["Zora's Domain"] || currentCheck.area === OverworldNames["Lake Hylia"]);
//
//             let isSpiritTempleHandsEntrance = previousCheck.area === null && previousCheck.entrance === DungeonNames["Spirit Temple"];
//
//             let isKakarikoGateEntrance = currentCheck.area === OverworldNames["Kakariko Village"] && currentCheck.entrance === OverworldNames["Death Mountain Trail"];
//
//             let isZorasDomainFromRiver = currentCheck.area === OverworldNames["Zora's River"] && currentCheck.entrance === OverworldNames["Zora's Domain"];
//
//             let isGerudosFortress = currentCheck.area === OverworldNames["Gerudo's Fortress"];
//
//             let isZorasDomainToZorasFountainEntrance = (currentCheck.area === OverworldNames["Zora's Domain"] && currentCheck.entrance === OverworldNames["Zora's Fountain"]) ||
...
//                     hyrule[currentCheck.area].entrances[currentCheck.entrance].leadsTo.area === OverworldNames["Zora's Domain"] &&
//                     hyrule[currentCheck.area].entrances[currentCheck.entrance].leadsTo.entrance === OverworldNames["Zora's Fountain"]);
//
//             let isCrossingHauntedWasteland = false;
//             let previousCheckIsHauntedWasteland = previousCheck.area === OverworldNames["Haunted Wasteland"];
...
//             let previousCheckIsGerudoValley = previousCheck.area === OverworldNames["Gerudo Valley"];
...
//                     (gerudoValleyEntranceBeingLedTo === OverworldNames["Gerudo's Fortress"] && gerudoValleyEntranceFromPreviousCheck === OverworldNames["Hyrule Field"]) ||
//                     (gerudoValleyEntranceBeingLedTo === OverworldNames["Hyrule Field"] && gerudoValleyEntranceFromPreviousCheck === OverworldNames["Gerudo's Fortress"]);
//             }
//
